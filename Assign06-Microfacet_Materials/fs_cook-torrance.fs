...
void main(void){
	...
	//f.r = fresnel(cos_theta_i, 0.25403, 3.3732);
	//f.g = fresnel(cos_theta_i, 1.061429, 2.5927);
	//f.b = fresnel(cos_theta_i, 1.15224, 2.4844);
	
	//f.r = fresnel(cos_theta_i, 0.17009, 3.1421);
	//f.g = fresnel(cos_theta_i, 0.7062, 2.0307);
	//f.b = fresnel(cos_theta_i, 1.26175, 1.8014);
